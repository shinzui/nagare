...
- [x] (2026-09-23) M1 partial: Explain now includes consumers from both active and retained declarations. A two-resource retirement fixture proves that a retained dependent remains visible after both active declarations leave the accepted scope vector. The CLI executable builds; collection still needs its own complete dependency and recovery gates.
