...
- [x] (2026-09-22) M3 partial: Compile the five shared bootstrap Namespaces and the packaged personal Job ResourceQuota into one foundation-owned typed bundle, with the quota ordered after its Namespace. The complete bundle composes without claim conflicts and each native member rebinds to its declaration. Namespace contribution registration and production command wiring remain open.
