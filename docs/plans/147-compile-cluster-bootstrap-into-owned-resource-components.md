...
- [x] (2026-09-22) M4 partial: Complete cloud and local candidate fixtures now compose foundation, configured upstream/issuer, auth databases and workloads, five observability scopes, and the applicable cache publication or MinIO scope. The fixtures check distinct native membership, scope count, and local backup ordering. Runtime command parity and review execution remain open.
