...
- [ ] M1b remaining: Prove update behavior across supported kinds, plus live stale UID/resourceVersion and foreign-object refusal through the registered command path.
