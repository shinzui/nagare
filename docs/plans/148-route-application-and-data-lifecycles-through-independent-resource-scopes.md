...
Reviewed application deploy also declares the per-Service release-history ConfigMap and carries forward accepted entries. The legacy history import path and static-site declaration remain open.
