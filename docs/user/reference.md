...
| `nagarectl app delete NAME --save-plan DIR [--scope-key KEY]` | Save retirement of an accepted application or standalone web-Service scope. Apply the review separately; managed members remain retained until their own collection reviews. |
