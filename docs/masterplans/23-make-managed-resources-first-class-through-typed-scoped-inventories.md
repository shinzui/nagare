...
- [x] (2026-09-23) EP-149 M3 collection screening: Read-only GC assessment now shares the executor's proved conditional-delete kind rule, so unsupported resources receive a blocker instead of a candidate flag. The 150 focused inventory tests and style check pass; broader collection and migration remain open.
